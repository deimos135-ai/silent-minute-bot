...
# 🔔 Повідомлення
messages = [
    "🕯 Щодня  — хвилина мовчання. Згадаємо Героїв, що віддали життя за 🇺🇦",
    "🕛 Час зупинитися і вшанувати полеглих. Пам’ятаємо. 💙💛",
    "🕯 Момент тиші. Хвилина мовчання за тими, хто не повернувся з бою.",
    "🙏 Приєднайся до хвилини мовчання. Віддай шану нашим Захисникам.",
    "🕛 Схилімо голови в пам'ять про тих, хто захищав нашу свободу.",
    "🕯 Ціна миру — життя Героїв. Зупинимось і вшануємо.",
    "🕯 Вшануймо тишею тих, хто виборов нам ранок.",
    "🙏 Зупинись на мить . Герої не вмирають.",
    "🕛Символічна тиша. Пам’ятаємо кожного, хто боровся за 🇺🇦",
    "🕯 Кожного дня пам’ятаємо тих, хто дав нам новий день."
]
...
async def setup_scheduler(bot, chat_id):
    ...
    scheduler.add_job(
        send_messages,
        trigger=CronTrigger(day_of_week='mon-fri', hour=7, minute=55, timezone=kyiv_tz),
        args=[bot, chat_id]
    )
